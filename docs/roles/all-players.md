...
> Where does my role need to be so this call works?
...
- literal pathing: clicking the word "south" without understanding why
- panic retreat: running after surviving enemy cooldowns
- backline clumping: stacking because the area feels safe
- role blindness: copying another role's position
- delayed response: waiting until the caller says the obvious thing
