...
> Is this build on a list?

Ask:

> What goal does this build accomplish, and do the weapon, armor, helmet, boots, cape, food, and potion work together to accomplish it?

## Three-part test

| Test | Question | Failure pattern |
|---|---|---|
...
- more mobility vs more cooldown
...
- [How to Read Weapon Notes](how-to-read-weapon-notes.md)
- [Armor and Defensive Tools](armor-defensive-tools.md)
- [DPS Weapon Notes](dps-weapons.md)
- [Tank / CC Weapon Notes](tank-cc-weapons.md)
